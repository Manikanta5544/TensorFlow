...
export function RegisterPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-64px)] max-w-md flex-col justify-center px-6 py-16">
      ...
      <p className="mt-2 text-sm text-muted">Join as a recruiter to post jobs, or a candidate to apply.</p>
      ...
      <form onSubmit={handleSubmit((values) => mutation.mutate(values))} className="mt-6 flex flex-col gap-4">
        <TextField
          label="Full name"
          autoComplete="name"
